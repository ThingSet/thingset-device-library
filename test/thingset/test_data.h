...
static const data_object_t dataObjects[] = {
    // info
    {0x1001, TS_CAT_INFO, TS_ACCESS_READ, TS_T_STRING, 0, (void*) manufacturer, "manufacturer"},

    // input data
    {0x3001, TS_CAT_INPUT, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_BOOL, 0, (void*) &(cal.load_enabled_target), "loadEnTarget"},
    {0x3002, TS_CAT_INPUT, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_BOOL, 0, (void*) &(cal.usb_enabled_target), "usbEnTarget"},

    // output data
    {0x4001, TS_CAT_OUTPUT, TS_ACCESS_READ, TS_T_INT32, 2, (void*) &i32, "i32_output"},

    // rpc / exec
    {0x5001, TS_CAT_EXEC, TS_ACCESS_EXEC, TS_T_BOOL, 0, (void*) &dummy, "dummy"},

    // calibration data
    {0x6001, TS_CAT_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_UINT64,  0, (void*) &ui64, "ui64"},
    {0x6002, TS_CAT_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_INT64,   0, (void*) &i64, "i64"},
    {0x6003, TS_CAT_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_UINT32,  0, (void*) &ui32, "ui32"},
    {0x6004, TS_CAT_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_INT32,   0, (void*) &i32, "i32"},
    {0x6005, TS_CAT_CONF, TS_ACCESS_READ | TS_ACCESS_WRITE, TS_T_UINT16,  0, (void*) &ui16, "ui16"},
...
static const ts_pub_channel_t pub_channels[] = {
    { "Serial", pub_data_objects, sizeof(pub_data_objects)/sizeof(uint16_t) }
};
