...
void test_txt_patch_bin_fetch(void)
{
    ...
    TEST_ASSERT_JSON2CBOR("ui64", "9223372036854775807", 0x6001,
    ...
    TEST_ASSERT_JSON2CBOR("i64", "9223372036854775807", 0x6002,
                          "1B 7F FF FF FF FF FF FF FF"); // maximum value for int64
#endif
    ...
    TEST_ASSERT_JSON2CBOR("i64", "-9223372036854775808", 0x6002,
...
void test_bin_patch_txt_fetch(void)
{
    ...
    TEST_ASSERT_CBOR2JSON("i64", "9223372036854775807", 0x6002,
                          "1B 7F FF FF FF FF FF FF FF"); // maximum value for int64
#endif
    ...
    TEST_ASSERT_CBOR2JSON("i64", "-9223372036854775808", 0x6002,
                          "3B 7F FF FF FF FF FF FF FF"); // maximum value for int64
#endif
    ...
    TEST_ASSERT_CBOR2JSON("DecFrac_degC", "27310e-2", 0x600B,
