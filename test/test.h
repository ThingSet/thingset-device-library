...
#define TEST_ASSERT_JSON2CBOR(name, json_value, id, cbor_hex_value) \
    assert_json2cbor(name, json_value, id, cbor_hex_value, \
                     ASSERT_MSG("TEST_ASSERT_JSON2CBOR(" #name ", " #json_value ", " #id \
                                ", " #cbor_hex_value ")"))
#define TEST_ASSERT_CBOR2JSON(name, json_value, id, cbor_hex_value) \
    assert_cbor2json(name, json_value, id, cbor_hex_value, \
                     ASSERT_MSG("TEST_ASSERT_CBOR2JSON(" #name ", " #json_value ", " #id \
                                ", " #cbor_hex_value ")"))
